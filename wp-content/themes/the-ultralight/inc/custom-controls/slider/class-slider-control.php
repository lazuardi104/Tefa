<?php
/**
 * The Ultralight Customizer Slider Control.
 * 
...
if ( ! class_exists( 'The_Ultralight_Slider_Control' ) ){
	/**
	 * Slider control (range).
    */
	class The_Ultralight_Slider_Control extends WP_Customize_Control {
        ...
        public function enqueue() {            
            wp_enqueue_style( 'the-ultralight-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'the-ultralight-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
