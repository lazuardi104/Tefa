...
Webfonts Loader
Blossom Travel local fonts feature is based on Webfonts Loader by WordPress Themes Team (WPTT). (https://github.com/WPTT/webfont-loader)
License: MIT
...
== Changelog ==
    ...
    1.1.9 - June 22, 2023
        * Fix: Warning shown in PHP 8 during plugin installation through TGMPA has been solved.
