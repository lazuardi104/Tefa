...
if ( ! class_exists( 'Influencer_Slider_Control' ) ) {

	/**
	 * Slider control (range).
	 */
	class Influencer_Slider_Control extends WP_Customize_Control {
        ...
        public function enqueue() {            
            wp_enqueue_style( 'influencer-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'influencer-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
