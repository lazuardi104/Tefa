...
<div id="help-panel" class="panel-left">
    ...
    <div class="panel-aside">
        <h4><?php esc_html_e( 'View Our Demo', 'the-conference' ); ?></h4>
        <p><?php esc_html_e( 'Visit the demo to get more idea about our theme design and its features.', 'the-conference' ); ?></p>
        <a class="button button-primary" href="<?php echo esc_url( 'https://rarathemes.com/previews/?theme='  . THE_CONFERENCE_THEME_TEXTDOMAIN . '/' ); ?>" title="<?php esc_attr_e( 'Visit the Demo', 'the-conference' ); ?>" target="_blank">
